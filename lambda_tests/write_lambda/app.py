...
def handler(event, context):
    ...
    tfidf_vectorizer_training_set=tfidf_vectorizer_training_set+customer_added_values_keys
    ...
    tfidf_matrix=my_TfidfVectorizer.fit_transform(tfidf_vectorizer_training_set)
